...
Make sure `SCANDIT_LICENSE_KEY` is available in your environment by doing one of the following:

- running `SCANDIT_LICENSE_KEY="YOUR_LICENSE_KEY" npm run build`
- placing your license key in a `.env` file at the root of the sample directory
- replacing the placeholder in `index.ts` with your quoted license key
