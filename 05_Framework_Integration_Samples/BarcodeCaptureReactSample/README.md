# BarcodeCaptureReactSample

An example of how to use the scanner in a React application.
...
- or by inserting your license key into `src/sdk.tsx`, replacing the placeholder `-- ENTER YOUR SCANDIT LICENSE KEY HERE --` with the key.
