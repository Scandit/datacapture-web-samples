...
class SDKController {
  ...
  public async initialize(): Promise<void> {
    ...
    try {
      ...
      this.state.context = await DataCaptureContext.forLicenseKey("-- ENTER YOUR SCANDIT LICENSE KEY HERE --", {
  ...
  public async setViewfinderVisible(visible: boolean): Promise<void> {
    ...
    if (visible && this.state.laserlineViewfinder) {
      ...
      await this.state.overlay.setViewfinder(null);
    }
  }
  ...
  private async initializeComponents(): Promise<void> {
    ...
    // Context is already created in initialize method
    this.state.camera = Camera.pickBestGuess();
