...
function showResult(capturedId) {
  ...
  if (capturedId.idImageOfType(m0.Face) != null) {
    ...
    result += `<img src="data:image/png;base64,${capturedId.idImageOfType(m0.Face)}" />`;
  }
...
var view;
var camera;
var supportedDocuments = [x0.DLVIZ, x0.IdCardVIZ];
async function run() {
  await Cs({
  ...
  camera = pe.default;
  await camera.applySettings(k1.recommendedCameraSettings);
