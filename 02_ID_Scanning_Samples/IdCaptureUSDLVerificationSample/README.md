# ID Capture US Driver License Verification sample

Example on how to use the Aamva barcode verifier to verify the validity of US driver license in your application.
