# Id Capture Shutter Mode Sample

Demonstrate the shutter mode of Id Capture: scan and capture both sides of a driver license using shutter mode, save captures after a review process.
...
Use the matching Scandit skill to get AI-assisted help for this sample. Install the Scandit skills collection once, then invoke the id-capture-web skill.
