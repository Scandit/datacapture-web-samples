<script lang="ts">
  ...
  export let rejectIdsExpiringInDays = $idCaptureSettingsStore.rejectIdsExpiringIn
    ? $idCaptureSettingsStore.rejectIdsExpiringIn.days
    : null;
</script>
  ...
  <svelte:fragment slot="content">
    ...
    <SettingsEntry to="/settings/id-capture/scanner">
      <div class="w-full flex">
        ...
        <div class="ml-auto">
          {$idCaptureSettingsStore.scanner.physicalDocument?.isFullDocumentScanner() ? "Full" : "Single side"}
        </div>
      </div>
    </SettingsEntry>
    ...
    <SettingsEntry to="/settings/id-capture/anonymization">
      <div class="w-full flex">
        <div>Anonymization</div>
        <div class="ml-auto">
          {camelCaseToTitleCase($idCaptureSettingsStore.anonymizationMode)}, {$anonymizedFieldsStore.size} fields
        </div>
      </div>
    </SettingsEntry>
    <SelectSetting
