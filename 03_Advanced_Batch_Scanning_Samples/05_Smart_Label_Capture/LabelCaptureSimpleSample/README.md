...
A simple example of setting up Label Capture to read product labels with barcodes and text fields.
...
- or by inserting your license key into `src/index.ts`, replacing the placeholder `-- ENTER YOUR SCANDIT LICENSE KEY HERE --` with the key.
