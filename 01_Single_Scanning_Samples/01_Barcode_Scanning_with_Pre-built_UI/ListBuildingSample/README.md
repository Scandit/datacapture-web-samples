...
A simple example of setting up the library to build a list by scanning barcodes using the pre-built SparkScan component.
...
- or by inserting your license key into `src/main.tsx`, replacing the placeholder `-- ENTER YOUR SCANDIT LICENSE KEY HERE --` with the key.
...
Use the matching Scandit skill to get AI-assisted help for this sample. Install the Scandit skills collection once, then invoke the sparkscan-web skill.
